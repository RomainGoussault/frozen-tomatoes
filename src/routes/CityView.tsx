// The v1 single-city lookup: search, stats card, chart, probability slider.
// Rendered at "/" by the router.
  ...
  return (
    <main className="flex flex-1 flex-col items-center gap-10 p-6 pt-24">
      <header className="flex flex-col items-center gap-4 text-center max-w-2xl">
        <h1 className="text-6xl font-light tracking-tight">Dernier gel</h1>
